...
namespace BitPro.SchoolMate.Accounts.Entities
{
    ...
    [ModifyPermission("Accounts:PaymentModify")]
    [InsertPermission("Accounts:PaymentCreate")]
    [DeletePermission("Accounts:PaymentDelete")]
    [UpdatePermission("Accounts:PaymentUpdate")]
    public sealed class PaymentRow : Row, IIdRow, IMultiTenantRow
    {
        ...
        [DisplayName("Affected Account"), ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jDebitAccount"), TextualField("DebitAccountAccountNo")]
        ...
        [DisplayName("SalaryPaymentEntityId")]
        public Int32? SalaryPaymentEntityId
        {
            get { return Fields.SalaryPaymentEntityId[this]; }
            set { Fields.SalaryPaymentEntityId[this] = value; }
        }
        ...
        public class RowFields : RowFieldsBase
        {
            ...
            public Int32Field SalaryPaymentEntityId;
