...
namespace BitPro.SchoolMate.Accounts.Entities
{
    ...
    [ModifyPermission("Accounts:ContraModify")]
    [InsertPermission("Accounts:ContraCreate")]
    [DeletePermission("Accounts:ContraDelete")]
    [UpdatePermission("Accounts:ContraUpdate")]
    public sealed class ContraRow : Row, IIdRow, IMultiTenantRow
    {
        ...
        [DisplayName("Debit Account Head"), NotNull, ForeignKey("[dbo].[AccountHeads]", "ID"), LeftJoin("jDebitAccountHead"), TextualField("DebitAccountHeadDescription")]
        ...
        [DisplayName("Credit Account Head"), NotNull, ForeignKey("[dbo].[AccountHeads]", "ID"), LeftJoin("jCreditAccountHead"), TextualField("CreditAccountHeadDescription")]
        ...
        [DisplayName("Debit Account"), ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jDebitAccount"), TextualField("DebitAccountAccountNo")]
        ...
        [DisplayName("Affected Account"), ForeignKey("[dbo].[Accounts]", "Id"), LeftJoin("jCreditAccount"), TextualField("CreditAccountAccountNo")]
        ...
        [DisplayName("Debit Account No"), Expression("jDebitAccount.[AccountNo]")]
        ...
        [DisplayName("Credit Account No"), Expression("jCreditAccount.[AccountNo]")]
