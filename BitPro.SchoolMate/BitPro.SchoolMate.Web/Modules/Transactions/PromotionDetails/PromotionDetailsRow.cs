...
namespace BitPro.SchoolMate.Transactions.Entities
{
    ...
    [LookupScript("Transactions.PromotionsDetails", Permission = "*")]
    public sealed class PromotionDetailsRow : Row, IIdRow,INameRow
    {
        ...
        public PromotionDetailsRow()
            : base(Fields)
        {
        }
        StringField INameRow.NameField
        {
            get { return Fields.Course; }
        }
