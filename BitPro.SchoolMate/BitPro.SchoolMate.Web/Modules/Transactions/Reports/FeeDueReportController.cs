namespace BitPro.SchoolMate.Transactions.Pages
{
    ...
    [PageAuthorize("Transactions:FeeDueReport"), Route("Transactions/FeeDueReport")]
    public class FeeDueReportController : Controller
    {
        public IActionResult Index()
        {
            ...
            return View(MVC.Views.Transactions.Reports.FeeDue, feeDueRequest);
        }
