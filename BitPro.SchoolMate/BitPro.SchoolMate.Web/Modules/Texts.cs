    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your Student Graph Password";
                ...
                {
                    public static LocalText FormTitle = "Student Graph";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your Student Graph Account";
                    ...
                    public static LocalText FormTitle = "Sign up for Student Graph";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = " Student Graph";
        }
        ...
        public static class Site
        {
            ...
            public static class Layout
            {
                ...
                public static LocalText FooterInfo = "BitPro Tech";
